    ...
    <div className="relative">
      <div
        className={`relative border rounded-lg transition-all duration-300 ${
          isFocused ? "border-blue-600 ring-2 ring-blue-100" : "border-gray-200"
        } bg-white`}
      >
        <Input
          id={id}
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-slate-50 overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-violet-500 rounded-full blur-[100px]"
        />
        ...
        <div className="relative z-10 max-w-lg">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-blue-100 text-sm font-medium"
            >
            ...
            >
              ...
              prioritize, and accomplish more with TodoFlow.
            </motion.p>
      ...
      >
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-2 text-center">
            ...
            >
              <div className="w-8 h-8 hover:scale-105 transition-transform duration-200 bg-linear-to-br from-blue-600 to-indigo-600 rounded-lg flex items-center justify-center text-white shadow-md">
                <CheckCircle2 className="w-5 h-5" />
              </div>
              <span className="text-xl font-bold text-slate-900">TodoFlow</span>
            </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg shadow-blue-500/25 transition-all hover:scale-[1.02] active:scale-[0.98] rounded-xl"
            >
              {loading ? (
