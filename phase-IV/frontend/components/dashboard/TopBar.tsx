...
export default function TopBar() {
  ...
  return (
    <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 px-4 sm:px-6 lg:px-8 flex items-center justify-between transition-all duration-300">
      {/* Left Area: Search */}
        ...
        >
          ...
          <input
            ...
            className={`w-full h-10 pl-10 pr-4 bg-slate-100 border-2 rounded-xl text-sm transition-all outline-none ${
              isSearchFocused
                ? "border-blue-600 bg-white shadow-[0_0_0_4px_rgba(37,99,235,0.1)]"
          ...
          <AnimatePresence>
            {showProfileMenu && (
              <motion.div
                ...
                className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden py-1 z-50 origin-top-right"
              >
