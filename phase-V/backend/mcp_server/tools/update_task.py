...
async def update_task(
    ...
    due_date: Optional[str] = Field(
        description="New due date in ISO format (e.g., '2025-12-31T10:00:00')",
        default=None,
    ),
    ...
    tags: Optional[str] = Field(
        description="New comma-separated tags (e.g., 'work, important')",
        default=None,
    ),
    recurring: Optional[str] = Field(
        description="New recurrence pattern: 'daily', 'weekly', or 'monthly'",
        default=None,
    ),
) -> Dict[str, Any]:
    """
    ...
    Args:
        ...
        recurring: New recurrence pattern (optional)
    ...
    try:
        ...
        # Validate recurring
        if recurring is not None and recurring not in [
            "daily",
            "weekly",
            "monthly",
            None,
        ...
        if not updates:
            return {
                "error": "No updates provided. Please specify a new title, description, due_date, priority, tags, or recurring.",
                "status": "error",
            }
